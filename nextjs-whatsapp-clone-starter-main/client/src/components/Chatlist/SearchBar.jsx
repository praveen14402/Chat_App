...
function SearchBar() {
  ...
  return <div className="bg-search-input-container-background flex py-3 pl-5 items-center gap-3 h-14">
        <div className="bg-panel-header-background flex items-center gap-5 px-3 py-1 rounded-lg flex-grow">
          ...
          <div>
            <input type="text" placeholder="Search or start a new chat" className="bg-transparent text-sm focus:outline-none text-white w-full" value={contactSearch}
            onChange={e => dispatch({type:reduceCases.SET_CONTACT_SEARCH,contactSearch:e.target.value})}/>
          </div>
        </div>
