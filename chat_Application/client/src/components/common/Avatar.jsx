...
const [showPhtotLibrary, setShowPhtotLibrary] = useState(false)
const [showCapturePhoto, setShowCapturePhoto] = useState(false)
  ...
  <>
       ...
       {type === "xl" && (
        ...
        >
          <FaCamera className="text-2xl" id ="context-opener"
            onClick={(e) => showContextMenu(e)}/>
          <span   onClick={(e) => showContextMenu(e)} id ="context-opener">Change <br></br> profile photo</span>
        </div>
     ...
     {showPhtotLibrary && <PhotoLibrary  setImage={setImage} hidePhotoLibrary={setShowPhtotLibrary}/>}
